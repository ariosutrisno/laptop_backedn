        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"  style="overflow-x:auto;">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Data Processor</h1>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="#" class="btn btn-warning btn-edit" data-toggle="modal" data-id="{{ $item->idx_processor }}" data-target="#modaledit">Edit</a>
                                                <a href="{{ url('/processor/ ' . $item->idx_processor . '/delete ') }}" class="btn btn-danger">Delete</a>
                                            </div>
                                        </td>
                                        </tr>
                                        @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('postprosesor') }}">
                        @csrf
...
$('.btn-update').on('click',function () {
    // console.log($(this).data('id'))
    let idx_processor = $('#editForm').find('#idx_processor').val()
    let formData = $('#editForm').serialize()
    $.ajax({
        url: `/processor/${idx_processor}/update`,
        method:"POST",
        data : formData,
        success: function (data) {
        console.log(data)
            // $('#modaledit').find('.modal-body').html(data)
            $('modaledit').hide()
            window.location.assign('/processor')
        },
        error:function (error) {
            console.log(error)
        }
