                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="#" class="btn btn-warning btn-edit" data-toggle="modal" data-id="{{ $item->idx_display }}" data-target="#modaledit">Edit</a>
                                                <a href="{{ url('/display/ ' . $item->idx_display . '/delete ') }}" class="btn btn-danger">Delete</a>
                                            </div>
                                        </td>
                                        </tr>
                                        @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('postdisplay') }}">
                        @csrf
...
$('.btn-update').on('click',function () {
    // console.log($(this).data('id'))
    let idx_display = $('#editForm').find('#idx_display').val()
    let formData = $('#editForm').serialize()
    $.ajax({
        url: `/display/${idx_display}/update`,
        method:"POST",
        data : formData,
        success: function (data) {
        console.log(data)
