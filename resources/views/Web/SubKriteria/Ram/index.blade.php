        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"  style="overflow-x:auto;">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Data Display</h1>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="#" class="btn btn-warning btn-edit" data-toggle="modal" data-id="{{ $item->idx_ram }}" data-target="#modaledit">Edit</a>
                                                <a href="{{ url('/display/ ' . $item->idx_ram . '/delete ') }}" class="btn btn-danger">Delete</a>
                                            </div>
                                        </td>
                                        </tr>
                                        @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('postram') }}">
                        @csrf
...
$('.btn-update').on('click',function () {
    // console.log($(this).data('id'))
    let idx_ram = $('#editForm').find('#idx_ram').val()
    let formData = $('#editForm').serialize()
    $.ajax({
        url: `/ram/${idx_ram}/update`,
        method:"POST",
        data : formData,
        success: function (data) {
        console.log(data)
