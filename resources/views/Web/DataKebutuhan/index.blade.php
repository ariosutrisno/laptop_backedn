...
@section('title','All Data Kebutuhan')
@section('content')
    <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"  style="overflow-x:auto;">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Data Kebutuhan</h1>
                    ...
                    <table class="table table-bordered text-center" id="dtHorizontalVerticalExample" width="100%">
                        <thead class="table-warning">
                            ...
                            <tbody>
                                <?php $no = 0;?>
                                @foreach ($data_semua_kebutuhan as $kebutuhan)
                                <?php $no++ ;?>
                                <tr>
                                    <td>{{ $no }}</td>
                                    <td>{{ $kebutuhan->kebutuhan_nama }}</td>
